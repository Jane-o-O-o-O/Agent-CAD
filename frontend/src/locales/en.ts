export default {
  ...
  'Friday': 'Fri',
  'Saturday': 'Sat',
  'Manus Computer': 'CAD大王的电脑',
  'Manus is using': 'CAD大王正在使用',
  'Jump to live': 'Jump to live',
  'Failed to load file content': 'Failed to load file content',
  'Give Manus a task to work on...': '给 CAD大王 一个任务...',
  // Shell tools
  ...
  'Are you sure you want to delete Claw?': '确定要删除 CAD大王助手吗？',
  'Chat history will be cleared. The Claw instance will remain available for re-creation.': '聊天记录将被清除，CAD大王助手仍可重新创建。',
  ...
  'Archive': 'Archive',
  // Login/Register Page
  'Login to Manus': '登录 CAD大王',
  'Register to Manus': '注册 CAD大王',
  'Full Name': 'Full Name',
  'Email': 'Email',
  'Password': 'Password',
  ...
  'Registration successful! Welcome to Manus': '注册成功！欢迎使用 CAD大王',
  ...
  'You are viewing a completed Manus task. Replay will start automatically in {countdown} seconds.': '您正在查看一个已完成的 CAD大王 任务。回放将在 {countdown} 秒后自动开始。',
  // Claw Page
  'Deploy OpenClaw Instantly': '启动 CAD大王助手',
  'OpenClaw is an AI assistant with unique personality and long-term memory, one-click deploy to sandbox cloud, no complex setup, 24/7 online': 'CAD大王 是面向 CAD 工作流的 AI 助手，可在沙盒环境中处理文件、工具调用和自动化任务。',
  'Chat Freely via Manus': '和 CAD大王 自由对话',
  ...
  'Create Manus Claw': '创建 CAD大王助手',
  'One-click OpenClaw deployment by Manus': 'CAD大王 为你一键创建助手环境',
  'Creating...': 'Creating...',
  'Create': 'Create',
  'Claw is initializing, please wait...': 'CAD大王助手正在初始化，请稍候...',
  'Claw is ready, let\'s chat!': 'CAD大王助手已就绪，开始聊天吧！',
  'Claw has stopped': 'CAD大王助手已停止',
  'Recreate': 'Recreate',
  'Claw failed to start': 'CAD大王助手启动失败',
  'Claw failed to start, please recreate.': 'CAD大王助手启动失败，请重新创建。',
  'Claw has stopped, please recreate to continue chatting.': 'CAD大王助手已停止运行，请重新创建以继续对话。',
  ...
  'Claw has expired, please recreate.': 'CAD大王助手已过期，请重新创建。',
}
